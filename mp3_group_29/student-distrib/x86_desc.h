...
#ifndef ASM
/* A page directory 4mb entry */
typedef struct __attribute__((packed))pd_entry_4m {
    uint32_t present        : 1;
    uint32_t r_w            : 1;
    uint32_t u_s            : 1;
    uint32_t pwt            : 1;
...
/* A page directory 4kb entry */
typedef struct __attribute__((packed))pd_entry_4k {
    uint32_t present     : 1;
    uint32_t r_w         : 1;
    uint32_t u_s         : 1;
    uint32_t pwt         : 1;
...
/* A page directory entry with possibly 4kb or 4mb entries*/
...
/* page table array and page directory array*/
pt_entry page_table[PAGE_ENTRY] __attribute__((aligned(4096)));
pd_entry page_directory[PAGE_ENTRY] __attribute__((aligned(4096)));
pt_entry page_table_vidmap[PAGE_ENTRY] __attribute__((aligned(4096)));
